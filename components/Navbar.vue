<template>
  <nav class="navbar navbar-expand-md bg-body-tertiary">
    <div class="container-fluid">
      <NuxtLink to="/" class="navbar-brand">Nuxt3 Starter</NuxtLink>
          ...
          <li class="nav-item dropdown">
            <button class="btn btn-link nav-link py-2 px-0 px-lg-2 dropdown-toggle d-flex align-items-center"
              ...
              <svg class="bi my-1 theme-icon-active">
                <use v-if="selectedTheme === 'auto'" href="#circle-half"></use>
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="bd-theme"
              ...
              <li>
                <button type="button" class="dropdown-item d-flex align-items-center" :class="[selectedTheme === 'light' ? 'active': '']" data-bs-theme-value="light"
              ...
              <li>
                <button type="button" class="dropdown-item d-flex align-items-center" :class="[selectedTheme === 'dark' ? 'active': '']" data-bs-theme-value="dark"
              ...
              <li>
                <button type="button" class="dropdown-item d-flex align-items-center" :class="[selectedTheme === 'auto' ? 'active': '']" data-bs-theme-value="auto"
                        @click="changeAppTheme('auto')">
                  <svg class="bi me-2 opacity-50 theme-icon">
